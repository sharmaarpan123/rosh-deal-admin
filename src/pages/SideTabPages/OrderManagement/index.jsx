...
const OrderManagement = () => {
  const column = [
    ...
    { head: "Scheduled at", accessor: "Scheduled" },
  ...
  const data = [
    {
      order: "#11081197",
      name: "Kathryn Murphy",
      serviceType: "Laundry and iron",
      Scheduled: "Feb 2, 2019 19:28",
      status: "pending",
    },
    {
      order: "#11081197",
  ...
  return (
    <>
      ...
      />
      <section className="orderManagement position-relative py-3">
        <Container>
          <Row>
            <Col lg="12">
