...
const Faq = () => {
  const column = [
    ...
    { head: "Question", accessor: "question" },
    {
      head: "Status",
      accessor: "",
      isComponent: true,
    ...
    },
    {
      ...
      component: (item) => (
        <div className="ActnBtn d-flex align-items-center  gap-10">
          <Link className="border-0 p-0" variant="transparent" to={`/faq/add`}>
            <svg
  ...
  const data = [
    ...
    {
      question:
        "Irate the visual form of a document or a typeface without relying on meaningful content. Lorem ipsum m",
      status: "inactive",
      CreatedAt: "Dec 7, 2019 23:26",
    },
  ];
  ...
  return (
    <>
      ...
      />
      <section className="faq position-relative py-3">
        <Container>
          <Row>
            <Col lg="12">
